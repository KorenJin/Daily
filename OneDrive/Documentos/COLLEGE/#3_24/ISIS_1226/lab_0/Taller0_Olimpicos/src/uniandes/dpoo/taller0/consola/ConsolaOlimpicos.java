...
public class ConsolaOlimpicos
{
	...
	public void modificacion1()
	{
		String name = input("Ingrese el nombre del atleta: ");
		String pais = calculadora.findPais(name);
		if (pais.equals(null))
		{
			System.out.println("Atleta no encontrado :c\n");
		}
		else {
			System.out.println("Atleta: "+name+" Pais: "+pais+"\n");
		}
	}
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Modificacion 1: buscar pais de un atleta\n");
	}
